...
const StarOfDavidLogo = () => (
  <svg width="32" height="32" viewBox="0 0 466 466" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	l-23.719-41.075l10.395-18.002l51.459,89.093H212.283z" fill="currentColor" />
  </svg>
)
    ...
    <header className="bg-secondary/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-4">
          <Link href="#features" className="text-primary hover:text-primary/80">Features</Link>
          <Link href="#cta" className="text-primary hover:text-primary/80">Get Started</Link>
          <Button 
            size="sm" 
